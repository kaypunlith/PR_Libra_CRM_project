...
//  }
  ...
  public ResponseMessage<OauthToken> responseToken(String authUrl, RestTemplate restTemplate, HttpEntity<MultiValueMap<String, String>> request, Long userId){
    int responseResult;
    String errorCode  = "401";
    String errorDesc  = "Unauthorized";
    OauthToken oauth2 = new OauthToken();
    ...
    if(responseResult == 1){
      ...
      return ResponseMessageUtils.makeResponse(false, messageService.message("User doesn't exist!", false, 0L));
    }
  }
