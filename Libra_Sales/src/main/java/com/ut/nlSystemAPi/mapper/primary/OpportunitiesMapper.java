...
public interface OpportunitiesMapper {
    ...
    Long getApplyCovertCustomerWithStage(@Param("id") Long id);

    Boolean updateLeadToCustomer(@Param("leadId") Long leadId);
    ...
    String getOpportunityChecklistData(@Param("opportunityId") Long opportunityId, @Param("stageId") Long stageId);

    Integer updateOpportunityChecklist(@Param("opportunityId") Long opportunityId, @Param("stageId") Long stageId, @Param("checkedData") String checkedData, @Param("userId") Long userId);

    Boolean insertOpportunityChecklist(@Param("opportunityId") Long opportunityId, @Param("stageId") Long stageId, @Param("checkedData") String checkedData, @Param("userId") Long userId);
